...
const AppSidebar = () => {
  ...
  const mainMenuItems = [
    ...
    { path: "/missions", text: "Ordres de travail", icon: <ClipboardList className="w-5 h-5" /> },
    { path: "/maintenance", text: "Maintenance préventive", icon: <CalendarRange className="w-5 h-5" /> },
  ...
  const referentielItems = [
    ...
    { path: "/missions", text: "Rapports d'intervention", icon: <FileText className="w-5 h-5" /> },
  ];
